...
// vType defaults resolver init cross-check for rung 6 (insertion-spacing, CLAUDE.md rule 6:
...
// above, exactly like Rung5InitCrossCheckTests.
public class Rung6InitCrossCheckTests
{
